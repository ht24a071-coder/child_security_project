...
define event_action_map = {
    "suspi_e_acquaintance": "「あっちに かわいいこいぬがいるんだ」と さそわれた",
    "suspi_e_car": "「くるまで おくってあげようか？」と さそわれた",
    "suspi_e_mom_injury": "「キミの おかあさんが けがをして びょういんに はこばれたんだ！」と いわれた",
    "suspi_e_test_1": "「おいしいケーキがあるんだけどこない？」と さそわれた",
    "suspi_e_test_2": "「くるまで おくってあげようか？」と さそわれた",
    "encounter_e_stranger": "「おいしい おかしが あるんだけど、たべない？」と さそわれた",
    "safe_e_lesson_dispatch": "じゅくの おくりむかえの えんじぇるぱとろーるに あった",
    "safe_e_railway": "ふみきりを あんぜんに わたった",
    "acquaintance": "「あっちに かわいいこいぬがいるんだ」と さそわれた", # 互換性
    "car_abduction": "「くるまで おくってあげようか？」と さそわれた", # 互換性
    "mom_injury": "「キミの おかあさんが けがをして びょういんに はこばれたんだ！」と いわれた", # 互換性
    "suspicious_event_1": "「おいしいケーキがあるんだけどこない？」と さそわれた", # 互換性
    "suspicious_event_2": "「くるまで おくってあげようか？」と さそわれた" # 互換性
}

define dummy_action_list = [
    "「みちを おしえてほしい」と いわれた",
    "「しゃしんを とらせて」と いわれた",
    "「おかねを あげるから おいで」と いわれた",
    "「いなくなった ねこを さがして」と いわれた",
    "「おもちゃを かってあげる」と いわれた",
    "「がっこうの せんせい だよ」と いわれた",
    "「えきまで つれていって」と いわれた"
]
